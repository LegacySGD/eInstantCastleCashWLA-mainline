...
public class CastleCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CastleCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CastleCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CastleCashWLAIW/InitOutcome.xml").getDocumentElement();
